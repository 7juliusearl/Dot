/*
  # Restore to latest subscription state
  
  1. Changes
    - Create backup of current subscriptions
    - Fix subscription data for all users
    - Update payment method information
    - Ensure proper subscription status
  
  2. Security
    - Maintains existing RLS policies
    - No data loss - creates backup first
*/
